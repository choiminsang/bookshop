					...
					<table>
						<tr>
							...
							<td ><input class="form-control"
								...
								value="${member.memberId}" style="width: 685px;"></td>
						</tr>
						<tr>
							<th>제목 *</th>
							<td><input required="required" class="form-control" id="title" name="title" value="${list.title}"
								placeholder="제목을 입력해주세요" style="width: 685px;"></td>
						</tr>
						<tr>
							<th>내용</th>
							<td><textarea required="required" cols="100" rows="30" name="content"></textarea></td>
						</tr>
						<tr>
							<th>이미지 첨부</th>
							<td ><img style="width: 500px; height:500px "
							src="/bupload/<c:out value="${list.uploadPath}/"/><c:out value="${list.uuid}_"/><c:out value="${list.fileName}"/> "></td>
						</tr>
					</table>
