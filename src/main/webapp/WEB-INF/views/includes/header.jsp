	...
	<div class="wrap">
		...
		<div class="top_area" style="color: white; background-color: gray">
            ...
            <form id="searchForm" action="/search" method="get">
               ...
               <input type="text" placeholder="검색어를 입력하세요."
                     class="search_area_input"
                     name="keyword" value='<c:out value="${pageMaker.cri.keyword}"></c:out>'
                  ...
                  <button class='btn search_btn'
                     style="width: 60px; height: 38px; border: 0px; background-color: #424242; outline: none; color: white; font-size: 16px; font-weight: 900;"
			...
			<div class="login_area">
				...
				<c:if test="${ member != null }">
					<div class="login_success_area">
						<span>고객명 : ${member.memberName} 님</span> <span>포인트 : <fmt:formatNumber value="${member.point}" pattern="#,###,###" /> P<br>
						<span>방문 감사합니다. 😍😘 </span>
		...
		<nav class="navi_bar_area">
			<a class="menulink" href="cate1?nationId=01">국내도서</a> <a
				class="menulink" href="cate2?nationId=02">국외도서</a> <a class="menulink"
				href="cate3">장르별</a> <a class="menulink" href="cate4">작가별</a> <a
				class="menulink" href="bbs">회원게시판</a>
		</nav>