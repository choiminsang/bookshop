	...
	<div class="user_wrap">
		...
		<div class="user_navi_wrap">
			<ul>
				...
				<lI><a class="user_list_04" href="memberDetail">내 정보수정 </a></lI>

			</ul>
		</div>

		<section id="content">
		 <div class="user_content_subject"><span>구매 목록 상세</span></div>
			<hr>
			<ul style="list-style: none;">
			<div class="thumb">
							<img
								src="/upload/img.jpg"  height="254px;"/>
						</div>
					...
					<li>
						...
						<div class="gdsInfo" style="display: contents;">
							<c:if test="${status.first}">
								<p
									style="padding-top: 30px; margin-left: 280px;">
									<h2>수령자 정보</h2>
									<span style="width: 73px; margin-right: 5px">수령인 : </span>${orderView.orderRec}
									<br> <span style="width: 60px; margin-right: 0px">주소
										: </span>(${orderView.userAddr1}) ${orderView.userAddr2}
									${orderView.userAddr3}<br> <span
										style="width: 103px; margin-right: 0px">구매 가격 : </span>
			...
			<ul style="list-style: none;">
				<c:forEach items="${orderView}" var="orderView">
					<li>
						...
						<div class="gdsInfo" style="display: contents;">
							<p
								style="padding-top: 10px; margin-left: 280px;">
								<h2>구매 상품 기본 정보</h2>
