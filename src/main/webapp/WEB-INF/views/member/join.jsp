                ...
                <div class="col-lg-12 col-md-12">
                    <form id="join_form" method="post">
                        ...
                        <div class="mail_wrap">
                            ...
                            <input class="mail_input form-control" name="memberMail" type="email">
                            <span class="final_mail_ck">이메일을 입력해주세요.</span>
                            <span class="mail_input_box_warn"></span>
                            <div class="mail_check_wrap">
                                <input class="mail_check_input" disabled="disabled">
                               <span class="final_mailck_ck"></span>
                        ...
                        <div class="join_button_wrap">
                            <input type="button" class="join_button form-control" value="회원가입" style="font-weight: bold; color:cornflowerblue;">
...
$(document).ready(function(){
	$(".join_button").click(function(){
		...
		/* 최종 유효성 검사 */
		if(idCheck&&pwCheck&&pwckCheck&&nameCheck&&mailCheck&&mailnumCheck&&addressCheck ){
